...
class RequestTrackingMiddleware(BaseHTTPMiddleware):
    ...
    This middleware generates a unique request ID, logs essential request information
    ...
    async def dispatch(self, request: Request, call_next: Callable) -> Response:
        """Dispatches the incoming request, adding tracking and logging.
        ...
        Args:
            ...
            call_next: The callable to process the request further down the middleware stack.
    ...
    def _get_client_ip(self, request: Request) -> str:
        """Extracts the client's IP address from request headers or client information.
        ...
        Returns:
            The client's IP address as a string, or "unknown" if not found.
        """
    ...
    def _get_safe_headers(self, headers) -> dict:
        """Filters out sensitive headers from a dictionary of request headers.
        ...
        Returns:
            A new dictionary containing only the non-sensitive headers.
        """
        sensitive_headers = {
            "authorization",
            "cookie",
